...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('images/site/' . (optional(settings())->site_favicon ?? 'default_favicon.png')) }}" />
                ...
                <ul id="accordion-menu">
                    ...
                    @if (auth()->user()->type == 'superAdmin')
                        <li>
                            <a href="{{ route('admin.categories') }}"
                                ...
                                <span class="micon fa fa-th-list"></span><span class="mtext">Thể loại</span>
                            </a>
                        </li>
                    @endif
                    ...
                    <li class="dropdown">
                        <a href="javascript:"
                            ...
                            <span class="micon fa fa-newspaper-o"></span><span class="mtext">Bài đăng</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="{{ route('admin.add_post') }}"
                                    class="{{ Route::is('admin.add_post') ? 'active' : '' }}">Thêm bài viết</a></li>
                            <li><a href="{{ route('admin.posts') }}"
                                    class="{{ Route::is('admin.posts') ? 'active' : '' }}">Danh sách bài viết</a></li>
                        </ul>
                    </li>
                    @if (auth()->user()->type == 'superAdmin')
                        {{-- <li class="dropdown">
                    ...
                    @if (auth()->user()->type == 'superAdmin')
                        <li>
                            <a href="{{ route('admin.settings') }}"
                                ...
                                <span class="mtext">Cài đặt chung
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.slider') }}"
                                ...
                                <span class="mtext">Quản lý slider
                                </span>
                            </a>
                        </li>
                    @endif
