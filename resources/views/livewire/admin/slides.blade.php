<div>
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <a href="javascript:;" wire:click="addSlide()" class="btn btn-success">
                    <i class="icon-copy bi bi-plus-circle"></i>Add Slider
                </a>
            </div>
        </div>
    </div>
                    ...
                    @forelse ($slides as $slide)
                        <tr data-index="{{ $slide->id }}" data-ordering="{{ $slide->ordering }}">
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge badge-pill badge-success">Unlisted </span>
                                @endif
                            </td>
                            <td>
    ...
    <div wire:ignore.self class="modal fade" id="slide_modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form class="modal-content" wire:submit.prevent="{{ $isUpdateSlideMode ? 'updateSlide' : 'createSlide' }}"
