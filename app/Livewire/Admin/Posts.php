...
class Posts extends Component
{
    ...
    {
        $this->resetPage();
        $this->postVisibility = $this->visibility == 'public' ? 1 : 0;
    }
    ...
    public function mount()
    {
        ...
        $this->postVisibility = $this->visibility == 'public' ? 1 : 0;
        $pcategories = ParentCategory::with(['children.posts'])
        ...
        return view('livewire.admin.posts', [
            'posts' => $user->type === 'superAdmin'
                ...
                ->when($this->visibility, function ($query) {
                    $query->where('visibility', $this->postVisibility);
                })
                ...
                ->where('author_id', $user->id)->paginate($this->perPage),
            'categories_html' => $this->categories_html,
        ]);
    }
}
